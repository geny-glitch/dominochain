...
import app.dominochain.mobile.api.ChasterLockResponse
import app.dominochain.mobile.api.ChasterTimeEventsResponse
import app.dominochain.mobile.api.FcmTokenRequest
import app.dominochain.mobile.api.NameRequest
import app.dominochain.mobile.api.PermissionsRequest
import app.dominochain.mobile.api.ProofResponse
import app.dominochain.mobile.api.RetrofitClient
import app.dominochain.mobile.api.RegisterRequest
import app.dominochain.mobile.api.RegisterResponse
import app.dominochain.mobile.api.TaskDetailResponse
import app.dominochain.mobile.api.TaskResponse
import app.dominochain.mobile.api.WallpaperItemResponse
import app.dominochain.mobile.api.WallpaperResponse
